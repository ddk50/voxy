  ...
  if (req.readyState == 4 && req.status == 200 
      && req.responseXML != null){
		...
		for( var i = 0; i < nl.length; i++ ) {
		  ...
		  items[items.length] = { src: src, id: id,
			                      xpos: xpos, ypos: ypos,
			                      width: width,
			                      height: height };
		}
...
function test_load_slides() {

  var images = [];
  
   images[images.length] =  { src: 'pngtest/1808047150.png',
	                          id: 1808047150,
	                          xpos: 0,
	                          ypos: 0,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/278496070.png',
	                          id: 278496070,
	                          xpos: 200,
	                          ypos: 0,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/178228751.png',
	                          id: 178228751,
	                          xpos: 400,
	                          ypos: 0,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/1003285001.png',
	                          id: 1003285001,
	                          xpos: 600,
	                          ypos: 0,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/1530607726.png',
	                          id: 1530607726,
	                          xpos: 0,
	                          ypos: 200,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/535181959.png',
	                          id: 535181959,
	                          xpos: 200,
	                          ypos: 200,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/34692691.png',
	                          id: 34692691,
	                          xpos: 400,
	                          ypos: 200,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/1681691886.png',
	                          id: 1681691886,
	                          xpos: 600,
	                          ypos: 200,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/1659841749.png',
	                          id: 1659841749,
	                          xpos: 0,
	                          ypos: 400,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/365374713.png',
	                          id: 365374713,
	                          xpos: 200,
	                          ypos: 400,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/947526210.png',
	                          id: 947526210,
	                          xpos: 400,
	                          ypos: 400,
	                          width: 200,
	...
	images[images.length] =  { src: 'pngtest/2105240560.png',
	                          id: 2105240560,
	                          xpos: 600,
	                          ypos: 400,
	                          width: 200,
