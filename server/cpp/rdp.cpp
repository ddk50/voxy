...
void rdp::rdp_out_unistr(STREAM s, char *string, int len)    
{
#ifdef HAVE_ICONV
 ...
 */
int rdp::rdp_in_unistr(STREAM s, char *string, int str_size, int in_len)    
{
#ifdef HAVE_ICONV
...
void rdp::rdp_send_logon_info(uint32 flags, char *domain, char *user,
...
void rdp::rdp_send_input(uint32 time, uint16 message_type,
...
RD_BOOL rdp::process_redirect_pdu(STREAM s /*, uint32 * ext_disc_reason */ )    
{
	uint32 len;
...
RD_BOOL rdp::rdp_connect(char *server, uint32 flags, char *domain, char *password,
...
RD_BOOL rdp::rdp_reconnect(char *server, uint32 flags, char *domain, char *password,
