...
#if 0 //not used
    VNCRFBproto();
    VNCRFBproto(const char *serveurname, int port);
    VNCRFBproto(unsigned int IPAddr, int Port, const char *pswdfile);    
#endif
    VNCRFBproto(const char *ServeurName, int Port, const char *pswdFile);
    ///< constructors
